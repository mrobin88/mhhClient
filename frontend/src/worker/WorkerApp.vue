...
const tabActive =
  'flex-1 min-w-0 inline-flex items-center justify-center gap-1.5 rounded-lg border border-teal-700 bg-teal-50 px-3 py-2 text-xs font-bold text-teal-900'
const tabIdle =
  'flex-1 min-w-0 inline-flex items-center justify-center gap-1.5 rounded-lg border border-transparent px-3 py-2 text-xs font-semibold text-slate-600 hover:bg-slate-100 hover:text-slate-950'
